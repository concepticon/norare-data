...
dsA = 'Scott-2019-Ratings'
dsB = 'Warriner-2013-AffectiveRatings'

valA = 'english_dominance_mean'
valB = 'english_dominance_mean'
...
plt.savefig('plot-test-english-dominance.pdf')
