...
dsA = 'Brysbaert-2014-Concreteness'
dsB = 'Scott-2019-Ratings'

valA = 'english_concreteness_mean'
valB = 'english_concreteness_mean'
...
plt.savefig('plot-test-english-concreteness.pdf')
