...
write_tsv(top_disgust, "examples/CD_top10_discrepancy_disgust.tsv")
write_tsv(top_sadness, "examples/CD_top10_discrepancy_sadness.tsv")
write_tsv(top_happiness, "examples/CD_top10_discrepancy_happiness.tsv")
write_tsv(top_fear, "examples/CD_top10_discrepancy_fear.tsv")
write_tsv(top_anger, "examples/CD_top10_discrepancy_anger.tsv")